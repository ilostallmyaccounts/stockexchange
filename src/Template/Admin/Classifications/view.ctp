    ...
    <ul class="side-nav">
		...
		<div class="dropdown hidden-xs">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			...
			<?= $this->Html->link(__('Edit Classification'), ['action' => 'edit', $classification->id], ['class' => 'dropdown-item']) ?>
			<?= $this->Form->postLink(__('Delete Classification'), ['action' => 'delete', $classification->id], ['confirm' => __('Are you sure you want to delete # {0}?', $classification->id)], ['class' => 'dropdown-item']) ?>
