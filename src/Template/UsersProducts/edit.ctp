...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $usersProduct->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $usersProduct->id)]
            )
        ?></li>
...
<div class="usersProducts form large-9 medium-8 columns content">
